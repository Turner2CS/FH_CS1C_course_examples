...
public class FHhashQP<E>
{
   ...
   public boolean insert( E x)
   {
      ...
      // checks if reinserting object
      boolean reinsert = false;
      if (mArray[bucket].state == DELETED && mArray[bucket].data.equals(x))
         reinsert = true;

      // add the new object to the bucket and set its state
      ...
      // check load factor
      // increase if not reinserting
      if( !reinsert && ++mLoadSize > mMaxLambda * mTableSize )
         rehash();
